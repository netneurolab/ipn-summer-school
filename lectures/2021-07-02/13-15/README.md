...
- copy and paste the first code block, run it, restart your run time, then run the second code block (approx 10 min). Don't close your collab notebook! This will be the notebook you use throughout the demos.
```
...
```
- run this ([![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/netneurolab/ipn-summer-school/blob/main/lectures/2021-07-02/13-15/fetch_and_parcellate_neurosynth.ipynb)) script (this will also take some time, approx 30 min)
