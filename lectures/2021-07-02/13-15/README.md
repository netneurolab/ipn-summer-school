...
```
- run this ([![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/netneurolab/ipn-summer-school/lectures/2021-07-02/13-15/fetch_and_parcellate_neurosynth.py)) script (this will also take some time, approx 30 min)
